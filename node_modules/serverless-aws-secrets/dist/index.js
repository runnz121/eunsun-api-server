"use strict";
const secret_1 = require("./aws/secret");
class ServerlessAWSSecret {
    ...
    options;
    serverless;
    constructor(serverless, cliOptions, options) {
    ...
    async loadSecrets(cli = false) {
        ...
        const secrets = await (0, secret_1.getSecret)(this.options.secretId, this.serverless.service.provider.region, this.log.verbose);
        let replacedCount = 0;
    ...
    replaceSecrets(secrets, replacedCount, environment, cli) {
        if (!environment) {
...
module.exports = ServerlessAWSSecret;
